...
public class MemberUpgradAdp extends RecyclerView.Adapter<MemberUpgradAdp.MyViewHolder> {
    ...
    public MemberUpgradAdp(Context context, ArrayList<GoodsClassItem> vehiclesList) {
...
//                .diskCacheStrategy(DiskCacheStrategy.ALL);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_member_upgrad, parent, false);
