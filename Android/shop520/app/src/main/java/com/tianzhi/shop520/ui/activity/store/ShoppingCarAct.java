...
public class ShoppingCarAct extends BaseFragmentActivity implements ShopcartAdapter.CheckInterface,
...
//    LinearLayout topBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentLayout(R.layout.act_shopping);
        context = this;
        aCache = ACache.get(context);
        initView();
//        setShowTitle(true);//隐藏标题
...
//                llCart.setVisibility(View.GONE);
    ...
    public void getCarlist() {
        ...
        OkGo.post(BaseConstant.GoodsUrl + BaseConstant.LISTCART)
                ...
                .execute(new DialogCallback<BaseResponse<ArrayList<ShopCarEntity>>>(this, false) {
                    @Override
...
//                        aCache.put(Constants.SHOPCAR,shopCarList);
    ...
    private void initEvents() {
        selva = new ShopcartAdapter(groups, children, context, this,shopCarList);
...
//        selva.setmListener(this);
    ...
    private void setCartNum() {
        ...
        if (count == 0) {
            ...
            setActivityTitle("购物车" + "(" + count + ")");
        }
    }

    private void clearCart() {
        setActivityTitle(("购物车" + "(" + 0 + ")"));
...
//            shopCarList = (ArrayList<ShopCarEntity>)aCache.getAsObject(Constants.SHOPCAR);
    ...
    public void doDecrease(int groupPosition, int childPosition,
        ...
        CarInfoEntity product = (CarInfoEntity) selva.getChild(groupPosition,
                childPosition);
        LogUtils.e("加减", product.toString());
        int currentCount = product.getNum();
        if (currentCount == 1)
            return;
        currentCount--;
    ...
    private void calculate() {
        ...
        if (totalCount == 0) {
            ...
            setActivityTitle("购物车" + "(" + totalCount + ")");
        }
    }
