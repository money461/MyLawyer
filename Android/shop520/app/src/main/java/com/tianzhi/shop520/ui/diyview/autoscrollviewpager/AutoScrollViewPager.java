package com.tianzhi.shop520.ui.diyview.autoscrollviewpager;
...
public class AutoScrollViewPager extends AutoScrollBase implements ViewPager.OnPageChangeListener {
    ...
    // 默认滑动时间间隔
    private final int DEFAULT_TIME_INTERVAL = 2000;
    // 默认指示器Margin Bottom
    private final int DEFAULT_BOTTOM_MARGIN = (int) util.dp2px(5);
    // 默认指示器间隔
    private final int DEFAULT_INDICTOR_SPACE = (int) util.dp2px(2);
        ...
        mScrollTask = new Runnable() {
            ...
            public void run() {
                if (null != mAdapter && mAdapter.getCount() > 1
                    ...
                    LogUtils.e("ssssssssssssssssss",mAdapter.count());
                    LogUtils.e("ssssssssssssssssss",mViewPager.getCurrentItem());
