...
//        request.headers("key","wJnd9WN8TV8V4zDU")
   ...
   /* @Override
    public T convertSuccess(Response response) throws Exception {
        ...
        if (typeArgument == Void.class) {
            ...
            Log.e("xxxxxxxxxxx",baseResponse.code.toString());
            Log.e("xxxxxxxxxxx",baseResponse.message.toString());
            //这里的0是以下意思
...
//                //比如：用户授权信息无效，在此实现相应的逻辑，弹出对话或者跳转到其他页面等,该抛出错误，会在onError中回调。
                throw new IllegalStateException("异地登录");
//            } else if (code == 105) {
