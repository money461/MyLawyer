...
public class OrderTotalFragment extends BaseLazyFragment implements OrderRclAdpter.notifyDataInterface{
    @BindView(R.id.recylcerview)
    RecyclerView recylcerview;
    private View view;
    private int screenWidth;//屏幕宽度
    Context context;
    private ArrayList<OrderEntity> orderEntities;//我的订单
