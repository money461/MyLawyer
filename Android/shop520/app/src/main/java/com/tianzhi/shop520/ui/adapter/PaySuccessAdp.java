...
public class PaySuccessAdp extends BaseQuickAdapter<GoodsInfoEntity, BaseViewHolder> {
    private Context context;
    int height;
    int width;
    public PaySuccessAdp(int layoutResId, List data, Context context, int width, int height) {
