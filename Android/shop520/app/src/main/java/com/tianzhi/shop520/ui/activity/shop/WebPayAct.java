...
/**
 * Created by wisdomnt on 2017/8/1.
 */
public class WebPayAct extends BaseFragmentActivity{
    private WebView wv_Help;
    private String URL;
    private String Mmethod;//请求方式
    private String param;//post请求参数
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentLayout(R.layout.activity_evaluation_help);
        initData();
        initView();
    }
    @Override
    ...
    private void initData() {
        if (paras == null || paras.isEmpty())
            return;
        URL = paras.getString("payUrl");
        Mmethod = paras.getString("method");
        param = paras.getString("param");
    }
    ...
    protected void initView() {
        ...
        // 设置布局方式
        wv_Help.getSettings().setLayoutAlgorithm(WebSettings.LayoutAlgorithm.SINGLE_COLUMN);
        // 设置可以访问文件
        ...
        if(Mmethod.equals("get")){
            ...
            wv_Help.postUrl(URL, EncodingUtils.getBytes(param, "base64"));
        }
    }
    @Override
