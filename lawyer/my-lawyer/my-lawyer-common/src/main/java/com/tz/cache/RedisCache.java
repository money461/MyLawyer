...
public class RedisCache {
	...
	public final static String CAHCENAME_ADMIN="|getPlatManagerToken|";//后台
	public final static String CAHCENAME_APP="|getUserToken|";//APP缓存名
	public final static String CAHCENAME_AUTH="|getAuthToken|";//权限token
	...
	public final static int ADMINCAHCETIME=3600;//缓存时间1小时  用户登录token
